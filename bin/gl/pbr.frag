...
void main()
{
	...
	vec3 fogColor = vec3(3.0/255.0, 3.0/255.0, 0);
	//vec3 ambientLightColor = vec3(100.0/255.0, 100.0/255.0, 100.0/255.0);
	...
	float specularStrength;
		...
		specularStrength = texelSpecular.a * 2.0;
	...
	material.specularColor = vec3(30.0/255.0, 30.0/255.0, 30.0/255.0);
	//material.specularColor = vec3(127.0/255.0, 127.0/255.0, 127.0/255.0);
	material.specularShininess = 50;
